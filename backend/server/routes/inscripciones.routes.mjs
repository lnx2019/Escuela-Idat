...
// // ======================================================
// // 🔵 GET /inscripciones/:id - OBTENER UNA INSCRIPCIÓN (Ruta dinámica)
// // DEBE IR DESPUÉS DE /count y /activo
// // ======================================================
...
// // ... (resto del código sin cambios, solo verifica que la ruta `/:id` esté después de `/count` y `/activo`)
